...
protected:
    ...
    void update_NAT_list_file();
    void fetch_region_information() const;
    ...
    bool check_user_existence_by_real_name(const string& input_real_name);
    bool check_user_existence_by_sno(const string& input_student_number);
    string return_real_name_by_sno(const string& input_student_number);
    string return_sno_by_real_name(const string& input_real_name);
    // pre_load
    void pre_generate_nat_file_location() const;
