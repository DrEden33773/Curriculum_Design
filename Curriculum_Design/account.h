...
protected:
    ...
    //提供密文格式
    static bool password_input_judger_with_fmt(const string& judged_str); // 密文输入密码，同时检验 是否与judged_str一致
    static string password_input_with_fmt_then_return_it(); // 密文输入密码，并将输入的密码返回
